...
export class ProdottiTipologieLavoratoriService {
 ...
 /*  getProdottiTipologieLavoratoriAll(): Observable<ProdottiTipologieLavoratori[]> {
    ...
    return this.http.get<ProdottiTipologieLavoratori[]>(environment.API_URI+'prodotti-tipologie-lavoratori');
  }
  ...
  inserisciProdottoTipologiaLavoratore(prodottoTiplav: ProdottiTipologieLavoratori): Observable<ProdottiTipologieLavoratori> {
    ...
    return this.http.post<ProdottiTipologieLavoratori>(environment.API_URI+'prodotti-tipologie-lavoratori', body, {headers});
  }
  ...
  rimuoviProdottoTipologiaLavoratore(id: number): Observable<ProdottiTipologieLavoratori> {
    ...
    const headers = {'content-type': 'application/json'};
    const body=JSON.stringify('');
    return this.http.post<ProdottiTipologieLavoratori>(environment.API_URI+'prodotti-tipologie-lavoratori/'+id as string + '/rimuovi', body, {headers});
  }
  ...
  getTipologieLavoratori(id: number): Observable<ProdottiTipologieLavoratori[]> {
    ...
    return this.http.get<ProdottiTipologieLavoratori[]>(environment.API_URI+'prodotti-tipologie-lavoratori/'+id+'/prodotti');
  }

  rimuoviProdottoTipologieLavoratori(idProdotto: number): Observable<ProdottiTipologieLavoratori> {
    const headers = {'content-type': 'application/json'};
    const body=JSON.stringify('');
    return this.http.post<ProdottiTipologieLavoratori>(environment.API_URI+'prodotti-tipologie-lavoratori/'+idProdotto as string + '/prodotto/rimuovi', body, {headers});
  } */
}
